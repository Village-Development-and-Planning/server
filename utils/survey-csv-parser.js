    ...
    if (!node[qNo] && node[optNo]) {
      ...
      */
      _createQuestion(node) {
        let qText = this.surveyOpts.question + '.Text.';
        let qType = this.surveyOpts.question + '.Type';
        let qTags = this.surveyOpts.question + '.Tags';
        let qNo = this.surveyOpts.question + '.No';
        let qPre = this.surveyOpts.question + '.PreReq.';
        let qPreQ = qPre + this.surveyOpts.question;
        let qPreOpt = qPre + this.surveyOpts.opt;
